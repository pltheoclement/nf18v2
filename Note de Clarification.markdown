...
Ces informations seront présentées sous la forme d’une base de données, dans laquelle elles seront stockées. Un programme python permettra de gérer les requêtes du gestionnaire de la clinique pour modifier la base de donnée en conséquence. 
